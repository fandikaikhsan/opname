...
import { ClipboardList, Search, Menu, ChevronDown, ChevronUp, ArrowLeft } from 'lucide-react';

interface Props {
  onBack: () => void;
}

export default function StockOpnameFeature({ onBack }: Props) {
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-40 font-sans animate-slide-up">
      {/* Sticky Header */}
        ...
        <div className="flex justify-between items-center max-w-md md:max-w-7xl mx-auto px-4 py-4 transition-all duration-300">
          <div className="flex items-center gap-3">
             ...
             <div>
                ...
                <p className="text-xs text-gray-400 font-medium">Input Stok Harian</p>
             </div>
          </div>
